...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 837, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
